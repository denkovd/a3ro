...
export type ModuleId = "trend" | "regime" | "earnings" | "bagholder";

const MODULE_SEQUENCE: ModuleId[] = ["trend", "regime", "earnings", "bagholder"];
...
const MODULE_META: Record<ModuleId, { label: string; route: string }> = {
  ...
  bagholder: { label: "Bagholder Risk Map", route: "/Projects/Bagholder-Risk-Map" },
};
